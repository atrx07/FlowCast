# Model Card: accident_h2

## Identity

- Model version: `classical_classification_v1`.
- Target: `target_accident_h2`.
...
- Training: `2025-01-01T00:00:00+05:30` through `2025-04-16T15:30:00+05:30` (123691 rows).
- Validation: `2025-04-16T17:00:00+05:30` through `2025-05-09T07:00:00+05:30` (26431 rows).
- Test: `2025-05-09T08:30:00+05:30` through `2025-05-31T22:30:00+05:30` (26432 rows).

## Probability and operating decision

- Sigmoid calibration applied: `True` (required_for_probability_output).
- Accident operating threshold: `0.0189995425`.
...
|---|---:|---:|---:|
| Validation | 0.5813 | 0.0131 | 26431 |
| Test | 0.6237 | 0.0182 | 26432 |
...
- Classifier: `artifacts/models/classical_classification_v1/accident_h2.joblib`.
