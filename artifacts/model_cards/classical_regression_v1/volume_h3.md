# Model Card: volume_h3

## Identity

- Model version: `classical_regression_v1`.
- Target: `target_volume_h3`.
...
|---|---:|---:|---:|---:|---:|
| Validation | 65.6565 | 44.2079 | 11.111% | 0.9442 | 27100 |
| Test | 65.3058 | 44.0438 | 10.952% | 0.9483 | 27100 |
...
- Pipeline: `artifacts/models/classical_regression_v1/volume_h3.joblib`.
