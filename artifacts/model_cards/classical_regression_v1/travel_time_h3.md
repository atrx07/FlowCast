# Model Card: travel_time_h3

## Identity

- Model version: `classical_regression_v1`.
- Target: `target_travel_time_h3`.
...
|---|---:|---:|---:|---:|---:|
| Validation | 1.0870 | 0.4357 | 9.699% | 0.7836 | 27100 |
| Test | 1.0822 | 0.4291 | 9.012% | 0.8247 | 27100 |
...
- Pipeline: `artifacts/models/classical_regression_v1/travel_time_h3.joblib`.
