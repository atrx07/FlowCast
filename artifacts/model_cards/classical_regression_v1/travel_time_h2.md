# Model Card: travel_time_h2

## Identity

- Model version: `classical_regression_v1`.
- Target: `target_travel_time_h2`.
...
|---|---:|---:|---:|---:|---:|
| Validation | 1.0853 | 0.4365 | 9.580% | 0.7853 | 27125 |
| Test | 1.0949 | 0.4393 | 9.316% | 0.8210 | 27125 |
...
- Pipeline: `artifacts/models/classical_regression_v1/travel_time_h2.joblib`.
